...
class ImageQualityGroup {
  ...
  static _HeadSizeAndPosition headSizeAndPosition = _HeadSizeAndPosition._privateConstructor();
  ...
  static _ShadowsAndLightning shadowsAndLightning = _ShadowsAndLightning._privateConstructor();
  ...
  static _PoseAndExpression poseAndExpression = _PoseAndExpression._privateConstructor();
...
class _Image {
  ...
  ImageQualityCharacteristic imageWidth(ImageQualityRange range) {
    return ImageQualityCharacteristic._create(ImageQualityCharacteristicName.IMAGE_WIDTH, recommended: range);
  }

  /// The image height, pixels.
  /// Doesn't have recommended value.
  ImageQualityCharacteristic imageHeight(ImageQualityRange range) {
    return ImageQualityCharacteristic._create(ImageQualityCharacteristicName.IMAGE_HEIGHT, recommended: range);
  }

  /// The image width to height proportion.
  /// Doesn't have recommended value.
  ImageQualityCharacteristic imageWidthToHeight(ImageQualityRange range) {
    return ImageQualityCharacteristic._create(ImageQualityCharacteristicName.IMAGE_WIDTH_TO_HEIGHT, recommended: range);
  }
  ...
  ImageQualityCharacteristic paddingRatio(ImageQualityRange range) {
    return ImageQualityCharacteristic._create(ImageQualityCharacteristicName.PADDING_RATIO, recommended: range);
  }
  ...
  ImageQualityCharacteristic artFace() {
    return ImageQualityCharacteristic._create(ImageQualityCharacteristicName.ART_FACE);
  }
...
class _Background {
  ...
  ImageQualityCharacteristic backgroundColorMatch({Color? color}) {
    return ImageQualityCharacteristic._create(ImageQualityCharacteristicName.BACKGROUND_COLOR_MATCH, color: color);
  }
