...
class FaceSDK {
  ...
  /// consequence of this.
  void deinitialize() async {
    await _bridge.invokeMethod("deinitialize", []);
  }
  ...
  Future<void> _onInit() async {
    ...
    _isInitialized = await _getIsInitialized();
  }

  Future<FaceSDKVersion?> _getVersion() async {
    return FaceSDKVersion.fromJson(
        await _bridge.invokeMethod("getVersion", []));
  }
  ...
  void _setServiceUrl(String? url) async {
    return await _bridge.invokeMethod("setServiceUrl", [url]);
  }
  ...
  Future<bool> _getIsInitialized() async {
