...
void main() {
  group("FaceSDK", () {
    ...
    compare(
        'imageQualityResult', imageQualityResult, ImageQualityResult.fromJson);
    compare('imageQualityCharacteristic', imageQualityCharacteristic,
    ...
    compare('detectFacesAttributeResult', detectFacesAttributeResult,
    ...
    compare(
        'detectFacesRequest', detectFacesRequest, DetectFacesRequest.fromJson);
    compare('detectFacesBackendException', detectFacesBackendException,
        DetectFacesBackendException.fromJson);
    compare('detectFacesException', detectFacesException,
        DetectFacesException.fromJson);
    compare('detectFacesResponse', detectFacesResponse,
    ...
    compare('faceCaptureException', faceCaptureException,
        FaceCaptureException.fromJson);
    compare('faceCaptureResponse', faceCaptureResponse,
    ...
    // compare(
    //     'verificationConfig', verificationConfig, VerificationConfig.fromJson);
    // compare('enrollmentRequest', enrollmentRequest, EnrollmentRequest.fromJson);
    // compare(
    //     'enrollmentRequest2', enrollmentRequest2, EnrollmentRequest.fromJson);
    compare('livenessBackendException', livenessBackendException,
    ...
    compare('livenessNotification', livenessNotification,
        LivenessNotification.fromJson);
    // compare('errorResponse', errorResponse, ErrorResponse.fromJson);
    // compare(
    //     'enrollmentResponse', enrollmentResponse, EnrollmentResponse.fromJson);
    // compare('verifyMatchResponse', verifyMatchResponse,
    //     VerifyMatchResponse.fromJson);
    // compare('verificationResponse', verificationResponse,
    ...
    compare('matchFacesDetectionFace', matchFacesDetectionFace,
        MatchFacesDetectionFace.fromJson);
    compare('matchFacesBackendException', matchFacesBackendException,
        MatchFacesBackendException.fromJson);
    compare('matchFacesException', matchFacesException,
        MatchFacesException.fromJson);
    compare('matchFacesDetection', matchFacesDetection,
    ...
    compare(
        'matchFacesResponse', matchFacesResponse, MatchFacesResponse.fromJson);
    compare(
        'comparedFacesSplit', comparedFacesSplit, ComparedFacesSplit.fromJson);

    compare('editGroupPersonsRequest', editGroupPersonsRequest,
    ...
    compare('searchPersonDetection', searchPersonDetection,
    ...
    compare('searchPersonRequest', searchPersonRequest,
