...
+(FaceSDKVersion* _Nonnull)faceSDKVersionFromJSON:(id _Nonnull)input;
+(NSDictionary<NSString*, id>* _Nonnull)generateFaceSDKVersion:(FaceSDKVersion* _Nonnull)input;
