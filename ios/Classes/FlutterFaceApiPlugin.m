...
NSMutableDictionary<NSString*, FlutterEventSink>* RFSWEventSinks;

@implementation RFSWCameraSwitchStreamHandler
- (FlutterError*)onListenWithArguments:(id)arguments eventSink:(FlutterEventSink)eventSink {
    RFSWEventSinks[RFSWCameraSwitchEvent] = eventSink;
    return nil;
}

- (FlutterError*)onCancelWithArguments:(id)arguments {
    RFSWEventSinks[RFSWCameraSwitchEvent] = nil;
    return nil;
}
@end
...
- (FlutterError*)onListenWithArguments:(id)arguments eventSink:(FlutterEventSink)eventSink {
    RFSWEventSinks[RFSWLivenessNotificationEvent] = eventSink;
    return nil;
}

- (FlutterError*)onCancelWithArguments:(id)arguments {
    RFSWEventSinks[RFSWLivenessNotificationEvent] = nil;
    return nil;
}
@end
...
- (FlutterError*)onListenWithArguments:(id)arguments eventSink:(FlutterEventSink)eventSink {
    RFSWEventSinks[RFSWVideoEncoderCompletionEvent] = eventSink;
    return nil;
}

- (FlutterError*)onCancelWithArguments:(id)arguments {
    RFSWEventSinks[RFSWVideoEncoderCompletionEvent] = nil;
    return nil;
}
@end
...
- (FlutterError*)onListenWithArguments:(id)arguments eventSink:(FlutterEventSink)eventSink {
    RFSWEventSinks[RFSWOnCustomButtonTappedEvent] = eventSink;
    return nil;
}

- (FlutterError*)onCancelWithArguments:(id)arguments {
    RFSWEventSinks[RFSWOnCustomButtonTappedEvent] = nil;
    return nil;
}
@end
...
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
    RFSWEventSinks = [NSMutableDictionary new];
    [self setupEventChannel:registrar :RFSWCameraSwitchEvent :[RFSWCameraSwitchStreamHandler new]];
    [self setupEventChannel:registrar :RFSWLivenessNotificationEvent :[RFSWLivenessNotificationStreamHandler new]];
    [self setupEventChannel:registrar :RFSWVideoEncoderCompletionEvent :[RFSWVideoEncoderCompletionStreamHandler new]];
    [self setupEventChannel:registrar :RFSWOnCustomButtonTappedEvent :[RFSWOnCustomButtonTappedStreamHandler new]];
    ...
    [FlutterFaceApiPlugin setChannel:channel];
...
- (void)handleMethodCall:(FlutterMethodCall*)call result:(FlutterResult)result {
    ...
    RFSWCallback callback = ^(id data) { result([RFSWJSONConstructor toSendable:data]); };
    NSDictionary* Switch = @{
